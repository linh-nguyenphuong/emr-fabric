...
async function main() {
    try {
        ...
        await contract.submitTransaction('updateEMR', '9858302d-041b-4bec-98d4-a017f2449295', JSON.stringify(patient), JSON.stringify(physician), JSON.stringify(room), JSON.stringify(medical_record));
