...
async function main() {
    try {
        ...
        if (!identity) {
            console.log('An identity for the user "physician" does not exist in the wallet');
            console.log('Run the enrollPhysician.js application before retrying');
            return;
        }
        ...
        const contract = network.getContract('emr-chaincode-user');
        ...
        let images = []
        await contract.submitTransaction('queryOwnEMR', '9858302d-041b-4bec-98d4-a017f2449294');
