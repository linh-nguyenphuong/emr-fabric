...
async function main() {
    try {
        ...
        let images = []
        await contract.submitTransaction('createEMR', '9858302d-041b-4bec-98d4-a017f2449295', JSON.stringify(patient), JSON.stringify(physician), JSON.stringify(room), JSON.stringify(living_functions), JSON.stringify(emr_diseases), JSON.stringify(emr_services), JSON.stringify(emr_drugs), JSON.stringify(images));
